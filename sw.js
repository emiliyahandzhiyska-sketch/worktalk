...
const CORE = [
  ...
  'decks.json',
  'mistakes.json',
  'dialogues-workplace.json',
  'dialogues-business.json',
  'dialogues-sales.json',
  'dialogues-marketing.json',
  'dialogues-customerservice.json',
  'dialogues-hr.json',
  'dialogues-finance.json',
  'dialogues-accounting.json',
  'dialogues-administration.json',
  'dialogues-it.json',
  'dialogues-techsupport.json',
  'dialogues-legal.json',
  'dialogues-healthcare.json',
  'dialogues-hospitality.json',
  'dialogues-technical.json',
  'dialogues-sport.json',
  'dialogues-nutrition.json',
  'dialogues-lifestyle.json',
  'dialogues-education.json',
  'dialogues-languagelearning.json',
  'grammar.json',
  'placement.html',
  'placement.js',
  'placement.json',
  ...
  'words-techsupport.json', 'exercises-techsupport.json', 'readings-techsupport.json',
  ...
  'words-education.json', 'exercises-education.json', 'readings-education.json',
  'words-languagelearning.json', 'exercises-languagelearning.json', 'readings-languagelearning.json',
